...
class GTN():
    ...
    def __init__(self, num_edge, num_channels, w_in, w_out, num_class, num_nodes, num_layers, **kwargs):
        ...
        self.embedder = nn.Linear(self.w_out * self.num_channels, self.w_out)
...
class HAN(BaseModel):
    ...
    def __init__(self, num_edge, w_in, w_out, num_class, num_nodes, num_layers, **kwargs):
