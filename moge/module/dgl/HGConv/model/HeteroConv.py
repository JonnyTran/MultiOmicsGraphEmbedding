...
class HeteroGraphConv(nn.Module):
    ...
    def forward(self, g: dgl.DGLHeteroGraph, input_src: dict, input_dst: dict,
                node_transformation_weight: nn.ParameterDict, nodes_attention_weight: nn.ParameterDict):
        """
