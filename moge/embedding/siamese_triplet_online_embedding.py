...
class SiameseOnlineTripletGraphEmbedding(SiameseTripletGraphEmbedding):
    ...
    def directed_pairwise_distances(self, embeddings):
    ...
    def undirected_pairwise_distances(self, embeddings):
    ...
    def batch_contrastive_loss(self, inputs):
        ...
        return contrastive_loss(y_pred, y_true)
    ...
    def build_keras_model(self, multi_gpu=False):
        ...
        with tf.device(device):
            ...
            directed_pairwise_distances = Lambda(self.directed_pairwise_distances)(embeddings)
            undirected_pairwise_distances = Lambda(self.undirected_pairwise_distances)(embeddings)
            print("directed_pairwise_distances", directed_pairwise_distances) if self.verbose else None

            directed_loss = Lambda(self.batch_contrastive_loss)(
                [directed_pairwise_distances, labels_directed])
            undirected_loss = Lambda(self.batch_contrastive_loss)(
