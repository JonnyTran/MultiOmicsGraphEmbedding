...
from moge.dataset.networkx.subgraph_generator import SubgraphGenerator
...
def make_dataset(network, directed=False,
    ...
    assert generator_train.seq_tokenizer.word_index == generator_test.seq_tokenizer.word_index
